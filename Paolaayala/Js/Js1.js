...
documento _ write ( `Operador ternario ${ 1  ==  2 ? true : false } <br>` ) ;
...
interruptor  ( operación )  {
  ...
  caso  "-" :
    ...
    romper ;
  caso  "*" :
    documento _ write ( `La multiplicacion es: ${ n1  *  n2 } <br>` ) ;
    romper ;
  caso  "/" :
...
/* llamar a la funcion */
documento _ escribe ( `Cuadrado v4 ${ cuadrado_v4 ( 3 ) } ` )
...
pág . innerHTML  =  "<strong>ADIÓS :)</strong>" ;